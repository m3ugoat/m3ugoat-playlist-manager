...
- `src/components/AccountSettings.tsx` renders the devices list and (for admins) the account list inside `SettingsPage`. It renders **nothing** when authentication is disabled, since there is no identity to manage.
